var gameState = {
  //makes the game state part of the global variables
  canvas: null,
  ctx: null,
  frameCallbackId: 0,
  isValid() {
...
export function init() {
  console.log("Init for game");
  gameState.canvas = globalThis.canvas;
  gameState.ctx = globalThis.ctx2d;

  gameState.pushEntity({
    position: { x: 10, y: 10 },
